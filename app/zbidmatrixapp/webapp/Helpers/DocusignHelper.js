...
], function (Fragment,JSONModel, MessageToast,MessageBox)
{
    "use strict";return {
        ...
        downloadSignedPdf:
async function (oController) {

    try {

        const sEnvelopeId =
            oController.envelopeId;

        if (!sEnvelopeId) {

            sap.m.MessageBox.error(
                "No Envelope ID Found"
            );
        ...
        */
        ...
        const response =
            await fetch(
                "/odata/v4/api-service-consumption/downloadSignedPdf",
                {
                    method: "POST",
        ...
        if (
            ...
            if (
                ...
                sap.m.MessageToast.show(
                    "Process is Not Completed - Waiting For Signature"
                );
        ...
        */
        sap.m.MessageToast.show(
                    "Signature Completed - Downloading PDF"
                );
        const blob =
            await response.blob();
